      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          for (int i = 0; i < noisy_observations.size(); i++){
              cout<<"obsv number = "<<i<<"" << "noisy obsv id = "<<noisy_observations[i].id<<endl;
          }
          */
		  //cout<<"noisy obsv size = "<<noisy_observations.size()<<endl;
		  //cout<<"map size = "<<map.landmark_list.size()<<endl;
